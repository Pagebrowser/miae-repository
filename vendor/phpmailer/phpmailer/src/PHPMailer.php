...
class PHPMailer
{
     ...
     * @var bool
     */
    public $SMTPAutoTLS = true;// Miae modification which I changed from true to false becoz the server supported STARTTLS hence upgrading the connection to encrypt it so I changed to false coz the emails don`t contain sensitive data
